...
export default function FormCategoria(){
    ...
    const excluir = async () => {
        await axios.delete(`http://localhost:6969/categoria/${id}`);
        voltar();
    };
    
    const selecionar = async () => {
        let { data } = await axios.get(`http://localhost:6969/categoria/${id}`);
    ...
    const alterar = async () => {
        ...
        await axios.put(`http://localhost:6969/categoria/${id}`, body);
        voltar();
    };
    ...
    const inserir = async () => {
        ...
        await axios.post(`http://localhost:6969/categoria`, body);
        voltar();
    };
